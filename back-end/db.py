...
api_key = "AIzaSyB2ARN0ezGG-zxwEWEUZQbt8CGRv8B4G4s"
user_agentt = "CareConnectApp/1.0 (dhruv@example.com)"
wiki = wikipediaapi.Wikipedia(language='en', user_agent=user_agentt)
