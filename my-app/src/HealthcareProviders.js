...
const apiUrl = "http://18.221.176.29:8080/healthcare-providers";
...
function Drugs() {
  ...
  const fetchData = async () => {
    let apiUrl = "";
    if (searchTerm !== "") {
      apiUrl = `http://18.221.176.29:8080/search/healthcare-providers/${searchTerm}?`;
    } else {
      apiUrl = "http://18.221.176.29:8080/healthcare-providers?";
    }
    if (type !== "") {
      apiUrl += `&type=${type}`;
    }
